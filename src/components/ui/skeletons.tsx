...
export function BaseSkeleton({
  ...
  return <Skeleton className={cn('bg-muted/60', className)} {...props} />
}
...
// TV Show card skeleton that matches the TVShowCard component structure
export function TVShowCardSkeleton({ className }: { className?: string }) {
  return (
      ...
      <div className="p-4">
        <div className="flex gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            {/* TV Show specific progress section */}
            <div className="mt-3 space-y-2">
              {/* Episode progress text and percentage */}
              ...
              {/* Progress bar */}
              <BaseSkeleton className="h-1.5 w-full rounded-full" />
              ...
              <div className="pt-2">
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <div className="text-center space-y-1">
                    <BaseSkeleton className="h-4 w-8 mx-auto" />
                  ...
                  <div className="text-center space-y-1">
                    <BaseSkeleton className="h-4 w-8 mx-auto" />
                    <BaseSkeleton className="h-3 w-14 mx-auto" />
                  </div>

                  {/* Up Next */}
                  <div className="text-center space-y-1">
                    <BaseSkeleton className="h-4 w-12 mx-auto" />
                    <BaseSkeleton className="h-3 w-12 mx-auto" />
                  </div>
                </div>
              </div>
